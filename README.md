...
```shell
  docker buildx build -t egekocabas/remote-docker:latest . --load
```
...
```shell
  docker extension dev reset egekocabas/remote-docker:latest
```
...
```shell
docker extension update egekocabas/remote-docker:latest
```
...
```shell
docker extension rm egekocabas/remote-docker:latest
```
